 ...
 */
final class Version20260119090806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATE DEFAULT NULL, lieu VARCHAR(255) NOT NULL, capacitÃe INT DEFAULT NULL, created_at DATE NOT NULL, auteur_id INT NOT NULL, INDEX IDX_B26681E60BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
